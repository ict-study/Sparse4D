...
model = dict(
    ...
    head=dict(
        ...
        instance_bank=dict(
            ...
            anchor="/root/code/Sparse4D-nuscenes/Sparse4D/nuscenes_kmeans900.npy",
...
data_root = '/root/code/Sparse4D-main/data/nuscenes/'
anno_root = '/root/code/Sparse4D-main/data/nuscenes_cam/'
...
load_from='/root/code/Sparse4D-main/fcos3d.pth'
